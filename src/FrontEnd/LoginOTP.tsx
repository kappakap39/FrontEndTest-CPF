                    ...
                    <div>
                        ...
                        <div className='sent'>
                            <input
                                ...
                                className="inputLoginOTP mt-1 blocks border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
                            />
                            {/* {!isValidEmail(values.Email) && (
                                <p style={{ color: 'red' }}>กรุณากรอกอีเมลให้ถูกต้อง</p>
                            )} */}
                            <button
                                type="button"
